...
namespace Heima8.OA.UI.Portal.Controllers
{
    public class WFTempController : Controller
    {
        ...
        private short delflagNormal = (short) Heima8.OA.Model.Enum.DelFlagEnum.Normal;
        ...
        {
            ViewData.Model =
                WF_TempService.GetEntities(u => u.DelFlag == DeleteFlag.DelflagNormal && u.ID == id).FirstOrDefault();
            return View();
        }
